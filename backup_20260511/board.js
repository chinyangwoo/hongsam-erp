// ═══════════════════════════════════════════════════════════════
// 홍삼한방타운 ERP — 전사 게시판 모듈 (board.js v2)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function getDefaultPosts() {
        return [
            ...
            { id:1002, cat:'공지사항', title:'4월 우수사원 포상식 결과 발표 및 커피차 안내', content:'4월 우수사원으로 스파운영팀 최민기 크루가 선정되었습니다.\n축하합니다! 🎉\n\n포상 내역 : 상장 + 상품권 10만원\n커피차 일정 : 4/16(수) 오후 2시, 1층 로비', author:'김지원', dept:'지원팀', date:'2026-04-15', views:48, pinned:true, comments:[
                {id:1,author:'최민기',dept:'스파운영팀',text:'감사합니다! 열심히 하겠습니다 😊',date:'2026-04-15 18:00'}
            ]},
